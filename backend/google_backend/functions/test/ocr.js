...
const centroid = require('../ocr/resultsProcessor').centroidOfConvexPolygon;
const isPhrase = require('../ocr/resultsProcessor').isProbablyPhrase;
const closestWord = require('../ocr/resultsProcessor').getWordClosestTo;
